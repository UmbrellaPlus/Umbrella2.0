...
buttonAnswer.addEventListener("click", () => {
  if (questionId !== 9) {
    ...
    buttonAnswer.addEventListener("click", () => {
      ...
      results.innerHTML =
        "Низкий риск (от 0 до 7 баллов): Вероятно, у вас нет проблем с алкоголем. Продолжайте пить умеренно или не пейте совсем. <br/> <br/>" +
        "Средний риск (от 8 до 15 баллов): Вы можете иногда выпивать слишком много. Это может подвергнуть опасности вас или окружающих. Постарайтесь сократить потребление алкоголя или полностью прекратить его употребление. <br/> <br/>" +
        "Высокий риск (от 16 до 19 баллов): Ваше употребление алкоголя может привести к вреду, если это еще не произошло. Важно сократить потребление алкоголя или полностью прекратить его употребление. Обратитесь к врачу за советом о том, как лучше всего сократить его потребление. <br/> <br/>" +
        "Вероятная зависимость (более 20 баллов): Вероятно, ваше употребление алкоголя причиняет вред. Спросите о лекарствах и консультациях, которые могут помочь вам бросить пить. Если у вас алкогольная зависимость, не прекращайте употребление алкоголя без помощи врача. <br/> <br/> <br/>" +
        "У вас" +
        " " +
        points +
        " " +
