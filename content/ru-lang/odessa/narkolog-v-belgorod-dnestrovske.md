...
* медикаментозное кодирование ( **инъекции от алкоголизма**, таблетки, импланты ) — препараты блокируют расщепление алкоголя или вызывают негативную реакцию при его употреблении
