...
* **Вывод из запоя:** Процедуры по детоксикации организма от продуктов распада алкоголя.
* **Капельницы от алкоголя или наркотиков:** Внутривенное введение растворов для восстановления водно-электролитного баланса, снятия интоксикации и улучшения общего состояния.
