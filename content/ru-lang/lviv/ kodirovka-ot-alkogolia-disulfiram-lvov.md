...
* Психологическая поддержка и рекомендации:
  Кодирование — это лишь первый шаг. Для достижения стойкого результата рекомендованы регулярные сеансы психотерапии, работа с психологом, участие в группах поддержки (например, «Анонимные Алкоголики»). Это помогает пациенту адаптироваться к трезвому образу жизни, решить глубокие психологические проблемы, ставшие причиной зависимости, и предотвратить возможные срывы.
