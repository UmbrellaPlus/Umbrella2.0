...
async function fetchQuestions() {
  try {
    const response = await fetch("/js/treatment-cost/questionsUa.json");
...
buttonAnswer.addEventListener("click", () => {
  if (questionId !== 2) {
    ...
    buttonAnswer.addEventListener("click", () => {
      ...
      results.innerHTML = "Вартість послуги від " + price + " гривень <br/>" + "Замовити послугу можливо зателефонуваваши за номером телефону<br/> " + '<a href="tel:+380687972782" style="color: navy; cursor: pointer">+380 (68) 797 27 82</a><br/>' + '<a href="tel:+3805002169" style="color: navy; cursor: pointer">+380 (50) 021 69 57</a>';
